...
CrMmWaveExample::CreateNodes ()
{
    ...
    if (m_tracing)
    {
        Ptr<OutputStreamWrapper> osw = m_ascii.CreateFileStream ("cr-2c.mob");
...
{   
    ...
    helper.SetSatandard (MMWAVE_COGNITIVE_RADIO_60GHz_2C_640MHz);
    ...
    if (m_tracing)
    {
        Ptr<OutputStreamWrapper> osw = m_ascii.CreateFileStream ( "cr-2c.tr");
