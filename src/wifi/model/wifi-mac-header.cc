    ...
    WifiMacHeader::SetType (WifiMacType type, bool resetToDsFromDs)
    {
        switch (type)
        {
            ...
            case WIFI_MAC_MGT_PROBE_RESPONSE:
                ...
                m_ctrlSubtype = 5;
                break;
            case WIFI_MAC_MGT_TX_BEACON:
                m_ctrlType = TYPE_MGT;
                m_ctrlSubtype = 6;
                break;
            case WIFI_MAC_MGT_RX_BEACON:
                m_ctrlType = TYPE_MGT;
                m_ctrlSubtype = 7;
                break;
        ...
        switch (m_ctrlType)
        {
            case TYPE_MGT:
                switch (m_ctrlSubtype)
                {
                    ...
                    case 6:
                        return WIFI_MAC_MGT_TX_BEACON;
                    case 7:
                        return WIFI_MAC_MGT_RX_BEACON;
                    case 8:
                        return WIFI_MAC_MGT_BEACON;
                    case 9:
                        return WIFI_MAC_MGT_NULL_BEACON;
                    case 10:
